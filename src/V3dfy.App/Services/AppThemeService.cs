...
public sealed class AppThemeService
{
    public void Apply(string theme)
    {
        ...
        SetBrush("DestructiveBrush", isDark ? "#DC2626" : "#DC2626");
        SetBrush("DestructiveHoverBrush", isDark ? "#B91C1C" : "#B91C1C");
        SetBrush("DestructivePressedBrush", isDark ? "#991B1B" : "#991B1B");
        SetBrush("ButtonForegroundBrush", "#FFFFFF");
        SetBrush("SecondaryButtonBackgroundBrush", isDark ? "#00FFFFFF" : "#F8FBFE");
        SetBrush("SecondaryButtonBorderBrush", isDark ? "#2B3A4B" : "#7F94A8");
        SetBrush("SecondaryButtonForegroundBrush", isDark ? "#F4F7FA" : "#17212B");
        SetBrush("SecondaryButtonHoverBackgroundBrush", isDark ? "#3385D6" : "#075CBF");
        SetBrush("SecondaryButtonHoverBorderBrush", isDark ? "#3385D6" : "#075CBF");
        SetBrush("SecondaryButtonHoverForegroundBrush", "#FFFFFF");
        SetBrush("SecondaryButtonPressedBackgroundBrush", isDark ? "#286BAE" : "#064B9B");
        SetBrush("SecondaryButtonPressedBorderBrush", isDark ? "#286BAE" : "#064B9B");
        SetBrush("SecondaryButtonPressedForegroundBrush", "#FFFFFF");
        SetBrush("DisabledBackgroundBrush", isDark ? "#344150" : "#E2E8F0");
        SetBrush("DisabledTextBrush", isDark ? "#8794A3" : "#64748B");
